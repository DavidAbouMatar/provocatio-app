...
export function fetchUserPosts(){
    ...
    "Authorization":"Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC8xMjcuMC4wLjE6ODAwMFwvYXBpXC9sb2dpbiIsImlhdCI6MTYzNTExNjgyNSwiZXhwIjoxNjM1MTIwNDI1LCJuYmYiOjE2MzUxMTY4MjUsImp0aSI6ImQxZjhMaFdERkZuTjhVVkoiLCJzdWIiOjEsInBydiI6IjIzYmQ1Yzg5NDlmNjAwYWRiMzllNzAxYzQwMDg3MmRiN2E1OTc2ZjcifQ.zvB2GzrVULHoUgN5GU_bZs_ZI80rGDx8XQPtO3ti-CM" }
     }).then(response => {
...
export function fetchUser(){
    ...
    return ((dispatch)=>{
        axios.get("http://127.0.0.1:8000/api/get_user_profile", { headers: { "content-Type": "application/json",
        "Authorization":"Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC8xMjcuMC4wLjE6ODAwMFwvYXBpXC9sb2dpbiIsImlhdCI6MTYzNTExNjgyNSwiZXhwIjoxNjM1MTIwNDI1LCJuYmYiOjE2MzUxMTY4MjUsImp0aSI6ImQxZjhMaFdERkZuTjhVVkoiLCJzdWIiOjEsInBydiI6IjIzYmQ1Yzg5NDlmNjAwYWRiMzllNzAxYzQwMDg3MmRiN2E1OTc2ZjcifQ.zvB2GzrVULHoUgN5GU_bZs_ZI80rGDx8XQPtO3ti-CM" } })
        .then(response => {
                dispatch( {
...
export const fetchUserFollowing = () => async dispatch => {
    ...
    // return((dispatch) = {
        ...
        const res = await axios.get("http://127.0.0.1:8000/api/get_user_profile", { headers: { "content-Type": "application/json",
...
export const login = (loginInput) => {
    ...
    const data = { "email": loginInput['email']['email'],"password": loginInput['password']['password']};
